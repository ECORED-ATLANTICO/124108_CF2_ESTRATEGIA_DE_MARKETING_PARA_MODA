  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .bg-full-width.bg-fondo-1
      .px-4.px-lg-5
        ...
        p.mb-5 Al mencionar lo anterior, debe entenderse que los entornos digitales no se pueden definir como un producto aparte, sino que son el resultado de la composición de varios medios, como los que se identifican a continuación:
        ...
        .row.mb-5.align-items-center.justify-content-center
          ...
          .col-lg-7
            AcordionA(tipo="a" clase-tarjeta="tarjeta bg-color-7")
              div(titulo="Medios propios")
                .row.justify-content-center.align-items-center.ms-5
    ...
    .row.mb-5.justify-content-center
      .col-sm-6.col-lg-3.mb-4.mb-lg-0(data-aos="fade-up")
        .tarjeta--boton.bg-color-sintesis.h-100.p-4
          .row.justify-content-center.mb-3
            .col-6
              figure
                img(src='@/assets/curso/tema1/8.svg', alt='')
    
          h3.bg-color-9.p-3.mb-4.text-center Plataformas educativas
          p.text-center Enfocadas en simular experiencias de aprendizaje.
      ...
      .col-sm-6.col-lg-3.mb-4.mb-lg-0(data-aos="fade-down")
        .tarjeta--boton.bg-color-sintesis.h-100.p-4
          ...
          h3.bg-color-9.p-3.mb-4.text-center Plataformas
            br
            sapn sociales
          p.text-center Más conocidas como redes sociales, enfocadas en la interacción entre usuarios.
      ...
      .col-sm-6.col-lg-3.mb-4.mb-lg-0(data-aos="fade-up")
        .tarjeta--boton.bg-color-sintesis.h-100.p-4
          ...
          h3.bg-color-9.p-3.mb-4.text-center Plataformas de comercio electrónico
          p.text-center Enfocadas en la comercialización digital de productos o servicios.
